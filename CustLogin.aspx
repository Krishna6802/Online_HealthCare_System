<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage(User).master" AutoEventWireup="true" CodeFile="CustLogin.aspx.cs" Inherits="CustLogin" %>
     ...
     <table id="tbl" runat="server" cellpadding="6" cellspacing="0" border ="0" width="75%" style="background-color:#DAF7A6;">
            ...
            <tr align="left" valign="top">
               <td align="center" valign="top" colspan="2">
                   ...
                   <h3 id="lblMsg" runat="server" visible="True" style="font-family:Verdana, Geneva, Tahoma, sans-serif; color:#FFFFFF; font-weight: 800; text-align: center; background-color: #013220;">Customer Login</h3>
               </td>   
           </tr>
          ...
          <tr align="left" valign="top">
               <td align="right" valign="top" style="width:40%">&nbsp;</td>
               <td align="left" valign="top">
                   <p style="color:#013220; font-family:Verdana; font-size:14px; font-weight:600">Don't Have Account ?? Register Here, <a href="CustRegister.aspx">Register</a></p></td>   
          </tr>
