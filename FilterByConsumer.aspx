<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage(User).master" AutoEventWireup="true" CodeFile="FilterByConsumer.aspx.cs" Inherits="FilterByBrand" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br /><br />
    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource1" DataTextField="Consumer_type" DataValueField="Consumer_id" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="True" AppendDataBoundItems="True" style="height:30px; width:250px; font-family:Verdana; font-weight:600; border:none; box-shadow:0 0.5rem 1.5rem rgba(0, 0, 0, 0.25); text-align:center; margin-left:550px;">
         <asp:ListItem Value="0">--Select Consumer--</asp:ListItem>
     </asp:DropDownList>
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_ecareConnectionString %>" SelectCommand="SELECT * FROM [tbl_Consumer] WHERE ([IsAct] = @IsAct)">
         <SelectParameters>
             <asp:Parameter DefaultValue="true" Name="IsAct" Type="Boolean" />
         </SelectParameters>
     </asp:SqlDataSource>
    <br /><br />
    <asp:Label ID="lblConsumer" runat="server" Text="" ForeColor="#013220" Font-Bold="True" align="center" style="margin-left:600px; margin-right:300px; padding-top:10px; padding-bottom:10px; font-weight:900" Font-Names="verdana" Font-Size="30px"></asp:Label><br /><br />
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td style="text-align: center; padding-right:80px;">
                        ...
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("Consumer_type") %>' style="color:#013220; font-weight:800; "></asp:Label>
                    </td>
                </tr>
                <tr>
    ...
    <br />
    <asp:Label ID="lblConsumerId" runat="server" Text="..." Visible="False"></asp:Label>
