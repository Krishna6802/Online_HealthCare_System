<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage(User).master" AutoEventWireup="true" CodeFile="SortByPrice.aspx.cs" Inherits="FilterByBrand" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <asp:DropDownList ID="DropDownList2" runat="server" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="True" style="height:30px; width:250px; font-family:Verdana; font-weight:600; border:none; box-shadow:0 0.5rem 1.5rem rgba(0, 0, 0, 0.25); text-align:center; margin-left:550px;">
         <asp:ListItem Value="0">Sort Price from Low to High</asp:ListItem>
         <asp:ListItem Value="1">Sort Price from High to Low</asp:ListItem>
     </asp:DropDownList>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td style="text-align: center; padding-right:80px;">
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("Prod_Name") %>'></asp:Label><br />
                        <asp:Label ID="Label5" runat="server" Text="Size : " ></asp:Label>
                        <asp:Label ID="Label6" runat="server" Text='<%# Eval("Size") %>' ></asp:Label><br /><br />
                        <asp:Label ID="Label3" runat="server" Text="Price : " style="color:#013220; font-weight:800; "></asp:Label>
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("MRP") %>' style="color:#013220; font-weight:800; "></asp:Label>
                        <asp:Label ID="Label4" runat="server" Text=" Rs." style="color:#013220; font-weight:800; "></asp:Label>
                    </td>
                </tr>
                <tr>
